...
public class MybatisTest {
	...
	public void create_test() {
		try {
			MyBatisConfiguration mybatis_config = ConfigurationBuilder.load(MyBatisConfiguration.class, repository_config_file_1) ;
			mybatis_config.setName("mybatis");
			System.out.println(ConfigurationBuilder.toJson(mybatis_config));

			Configuration config =  ConfigurationBuilder.save(mybatis_config, repository_config_file_1);
