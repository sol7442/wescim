...
@Data
public class Configuration extends ConfigData {
	private String name;
	...
	public Configuration build() throws ScimException {
	...
	public boolean isFile() {
		return implClss != null && this.settings == null ;
	}
//	public void load() throws ScimException {
//		if(isFile()) {
//			try {
//				Class<?> conifg_class =  Class.forName(implClss);
//				Configuration config = (Configuration) load(conifg_class, fileName);
//				
